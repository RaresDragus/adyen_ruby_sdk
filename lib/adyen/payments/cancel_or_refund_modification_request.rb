...
module Adyen
  ...
  module Payments
    # Contains data for a cancellation or refund of an authorised payment that may or may not have been captured,
    # used for /cancelOrRefund endpoint
    #
    ...
    #
    class CancelOrRefundModificationRequest < ApiObject
